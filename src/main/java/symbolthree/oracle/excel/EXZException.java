...
public class EXZException extends Exception {
     ...
     *
     */
    private static final long serialVersionUID = -3376444183761839564L;
     ...
     * @param message
     */
    public EXZException(String message) {
        super(message);
     ...
     * @param cause
     */
    public EXZException(Throwable cause) {
        super(cause);
     ...
     * @param cause
     */
    public EXZException(String message, Throwable cause) {
        super(message, cause);
