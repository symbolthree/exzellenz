 ...
 * ================================================
 *
 * $Archive: /TOOL/EXZELLENZ/src/symbolthree/oracle/excel/FileDrop.java $
...
public class FileDrop {
    ...
    private static boolean supportsDnD() {    // Static Boolean
        if (supportsDnD == null) {
            ...
            try {
                @SuppressWarnings("unused") Class arbitraryDndClass = Class.forName("java.awt.dnd.DnDConstants");
    ...
    private void makeDropTarget(final java.io.PrintStream out, final java.awt.Component c, boolean recursive) {
        ...
        if (recursive && (c instanceof Container)) {
            ...
            // Get the container
            java.awt.Container cont = (Container) c;
    ...
    public static class Event extends EventObject {
         ...
         *
         */
        private static final long serialVersionUID = -4404531042007036394L;
        private File[]            files;
